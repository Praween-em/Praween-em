<!-- This is a standard image, GitHub will display it at the top of your README. -->
<!-- It serves as a visual header or background element for the top portion of your profile. -->
<img src="1920x1080-yellow-solid-color-background.jpg" alt="Solid Bright Yellow Background" width="100%" style="display: block; margin-bottom: 20px;">

<!-- Main content container - GitHub typically ignores background-color on this top-level div for READMEs. -->
<!-- The styling here is primarily for text color, font, and overall structure. -->
<div style="font-family: 'Inter', sans-serif; color: #000000; padding: 0 10px;">
  ...
  <div align="center" style="margin-bottom: 40px;">
    ...
    <!-- Social Badges - Using pure Markdown for best compatibility and consistent rendering -->
